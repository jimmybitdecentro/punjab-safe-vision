      ...
      <aside className="w-64 shrink-0 bg-[hsl(var(--navy))] text-primary-foreground flex flex-col">
        <div className="p-5 border-b border-white/10">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="font-black text-sm leading-tight">NashaMukt Himachal</p>
              <p className="text-[10px] opacity-70">Command Centre · Una</p>
            </div>
          </div>
        </div>
...
function Overview({ stats, reports, zones, onOpenReport }: any) {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Live heatmap */}
      <div className="rounded-2xl border border-border bg-card p-5">
        <h3 className="font-bold mb-4">Una — Live Heatmap</h3>
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-2xl border border-border bg-card overflow-hidden">
        <div className="flex items-center justify-between px-4 py-3 border-b border-border">
          <h3 className="font-bold">Officer Roster · Una Pilot</h3>
          <div className="flex items-center gap-2">
      ...
      <div className="rounded-2xl border border-border bg-card p-5">
        ...
        <div className="space-y-2 text-sm">
          {[
            ...
            { tier: "High · L1 (15m)", to: "DSP Una", channel: "SMS + Call" },
            { tier: "High · L2 (30m)", to: "SP Una", channel: "Call" },
      ...
      <div className="rounded-2xl border border-border bg-card p-5">
        ...
        <div className="space-y-2 text-sm">
          {[
            ...
            { name: "CCTNS — Himachal Police", status: "Connected", color: "badge-success" },
            { name: "Safe City CCTV Grid — Una", status: "Connected", color: "badge-success" },
