...
const problems = [
  { icon: AlertTriangle, title: "Widespread Drug Abuse", desc: "Himachal faces one of India's most severe drug crises, affecting youth, families, and communities across the state.", color: "text-accent" },
