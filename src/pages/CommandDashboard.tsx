...
function OfficersSection() {
  const officers = [
    { id: "PB-LDH-1042", name: "Insp. Harpreet Kaur", rank: "Inspector", station: "Panchkula HQ", division: "Central", shift: "Day (08:00–20:00)", contact: "+91 98xx-xx-1042", active: 12, resolved: 87, sla: 94, arrests: 18, status: "On Duty" },
      ...
      <div className="rounded-2xl border border-border bg-card p-5">
        ...
        <div className="space-y-2 text-sm">
          {[
            ...
            { tier: "High · L2 (30m)", to: "SP Panchkula Rural", channel: "Call" },
